...
public class ClassGeneratorUtil implements Constants 
{
	...
	*/
		...
		String returnType, String[] paramTypes, int modifiers, ClassWriter cw )
	{
		...
		cv.visitMethodInsn(
			INVOKEVIRTUAL, "art/arcane/bsh/This", "invokeMethod",
		...
		cv.visitMethodInsn(
		  INVOKESTATIC, "art/arcane/bsh/Primitive", "unwrap",
	...
	*/
		...
		int index, String [] paramTypes, int modifiers, ClassWriter cw )
	{
		...
		cv.visitMethodInsn(
			INVOKESTATIC, "art/arcane/bsh/ClassGeneratorUtil", "initInstance",
	...
	void generateStaticInitializer( ClassWriter cw )
	{
		...
		cv.visitMethodInsn(
			INVOKESTATIC, "art/arcane/bsh/ClassGeneratorUtil", "initStatic",
			"(Ljava/lang/Class;)V");
	...
	*/
		...
		int consIndex, int argsVar, int consArgsVar, CodeVisitor cv )
	{
		...
		cv.visitMethodInsn(
			INVOKESTATIC, "art/arcane/bsh/ClassGeneratorUtil", "getConstructorArgs",
		...
		cv.visitFieldInsn(
			GETFIELD, "art/arcane/bsh/ClassGeneratorUtil$ConstructorArgs", "selector", "I" );
	...
	*/
	...
	)
	{
		...
		for (int i=0; i<paramTypes.length; i++)
		{
			...
			String className = "art/arcane/bsh/ClassGeneratorUtil$ConstructorArgs";
			String retType;
		...
		String [] paramTypes, boolean isStatic, final CodeVisitor cv )
	{
		...
		for (int i = 0; i < paramTypes.length; ++i)
		{
			...
			if ( isPrimitive( param ) )
			{
				...
				String type = "art/arcane/bsh/Primitive";
